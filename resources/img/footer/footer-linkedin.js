...
const LinkedIn_svg = () => (
<svg className="footer__bottom-list-item-linkedin" width="24" height="24" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
