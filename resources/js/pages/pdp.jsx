...
function Plp() {
            ...
            <div className="descr__inner">
                ...
                <div className="descr__block">
                    ...
                    <div className="descr__block-inner-buttons">
                        ...
                        <Link onClick={setProducts} className="descr__block-inner-buttons-add" to="/cart">
                            Add to cart
                        </Link>
                    </div>
                </div>
    ...
    <CollectionSection imgClass={'collection__list-item-img'} nameClass={'collection__list-item-h4'} priceClass={'collection__list-item-p'}/>
    </>
